 ...
 */
public class NewConfigurationOperation extends AbstractRuntimeOnlyHandler {
    ...
    static void register(ManagementResourceRegistration resourceRegistration) {
        resourceRegistration.registerOperationHandler(DEFINITION, new NewConfigurationOperation());
    }

    private NewConfigurationOperation() {
    }

    @Override
    protected void executeRuntimeStep(OperationContext context, ModelNode operation) {
        context.getResult().set("This is a new configuration option for MP 3.x");
    }
}
